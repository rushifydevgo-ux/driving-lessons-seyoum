...
const SERVICES = [
  {
    ...
    desc: "If you've never sat in the driver's seat, we start there. Empty lots first — mirrors, pedals, signals — then quiet residential streets, then real San Jose traffic. You set the pace, and we don't move on until you're comfortable.",
    bullets: [
  ...
  },
  {
    ...
    desc: 'I drive the exact DMV routes here in San Jose — Senter Road, Capitol Expressway, the surrounding streets — so on test day nothing surprises you. Pickup at the DMV included, and the lesson car is yours to use for the road test itself.',
    bullets: [
...
export default function Services({ onBook }) {
  return (
    <section className="bmw-section bmw-section--light" data-screen-label="02 Services">
