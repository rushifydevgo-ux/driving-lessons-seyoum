...
/* ----- DatePicker (Calendly-style: full calendar, click to pick) ----- */
...
/* ----- Main Booking — Calendly-style embed ----- */
function Booking() {
  ...
  return (
    <section className="rd-book-band" id="book-section" data-screen-label="04 Booking">
      <div className="bmw-container">
        <div className="rd-sec-head rd-sec-head--center">
          ...
          <p className="rd-sec-head-sub">
            Choose any open slot below. The appointment syncs straight to my Google Calendar, and
            you'll get a confirmation by text. No deposit, no card — payment is cash at the lesson.
          </p>
        </div>

        <div className="rd-book-shell">
          {/* Embed header — frames this as the calendar widget */}
          ...
          <div className="rd-book-shell-body">
            ...
            {step === 2 && (
              <div className="rd-confirm">
                ...
                <p>
                  This appointment has been added to Seyoum's calendar. He'll text {form.phone} within
                  a few hours to confirm and share his exact ETA on the day.
                </p>
          ...
          {/* Powered-by strip — Calendly embed framing */}
          <div className="rd-book-shell-foot">
            <span>Calendar synced via Google Calendar · Free reschedule with 24h notice</span>
          </div>
        </div>
      </div>
    </section>
